...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// AbstractApplicationContext ctx = new AnnotationConfigApplicationContext("com.gdu.app01.java01"); 	// com.gdu.app01.java01 패키지에 있는 모든 Bean을 주세요!(configration이 많은 경우)
